/**
 * RE² Scoring Utilities — Canonical Score Computation (SERVER-SIDE)
 * ──────────────────────────────────────────────────────────────────────────
 * @deprecated 04.19.2026 — For Svelte page context use scoring-utils.svelte.ts
 *   instead. This file exists solely because SvelteKit server routes cannot
 *   import .svelte.ts files. Both files must stay in sync.
 *
 *   Current server-side caller: src/routes/api/shortlist/compare/+server.ts
 *   Svelte-context callers: src/routes/app/location/+page.svelte
...
// 04.19.2026 Imported from scoring-thresholds to match scoring-utils.svelte.ts (eliminates magic numbers 40/55)
...
export function classifySignal(score: number): SignalFlag {
	// 04.19.2026 Imported from scoring-thresholds — matches scoring-utils.svelte.ts (B2-1.1)
